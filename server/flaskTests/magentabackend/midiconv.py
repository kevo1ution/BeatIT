...
def to_audio(sf2, midi_file, out_dir, out_type='wav', txt_file=None, append=True):
    ...
    """
    sf2 = "/Users/engrbundle/Desktop/MusicGeneration/RapBeats/TimGM6mb.sf2"
    midi_file = "/Users/engrbundle/Desktop/MusicGeneration/RapBeats/musicvae.mid"
    out_dir = "/Users/engrbundle/Desktop/MusicGeneration/RapBeats/"
    #fbase = os.path.splitext(os.path.basename(midi_file))[0]
    if not txt_file:
        out_file = out_dir + 'gimme.wav'
    else:
        line = 'out'
    ...
    try:
        ...
        if not textfiles or len(textfiles) < len(midifiles):
            for mid in midifiles:
                to_audio("", "", out_dir, out_type)
        else:
            for mid, txt in zip(midifiles, textfiles):
                to_audio("", "", out_dir, out_type, txt, append)
